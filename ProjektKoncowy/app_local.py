...
model = load_model('airflow/models/prototype')
...
def preprocess_input(data):
    # Define the path to scalers
    scaler_dir = 'airflow/models'
    standard_scaler_path = f"{scaler_dir}/standard_scaler.pkl"
    minmax_scaler_path = f"{scaler_dir}/min_max_scaler.pkl"

    # Load scalers
    standard_scaler = joblib.load(standard_scaler_path)
    minmax_scaler = joblib.load(minmax_scaler_path)
    logger.info("Loaded scalers for preprocessing.")
